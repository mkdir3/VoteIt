            ...
            <div class="w-70 mr-5">
                ...
                >
                    <div class="text-center px-6 py-2 pt-6">
                        ...
                        <p class="text-xs mt-4"> Dites nous ce qu'il vous passe par la tête.</p>
                    </div>
                    <form action="" method="POST" class="space-y-4 px-4 py-6">
                        <div>
                          <input type="text" class="text-xs w-full bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Votre idée">  
                        </div>
                        <div>
                            <select name="category_add" id="category_add" class="w-full bg-gray-100 text-xs rounded-xl border-none px-4 py-2">
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl border-none text-xs px-4 py-2" placeholder="Décrivez votre idée"></textarea>
                        </div>
                        <div class="flex items-center justify-between space-x-3">
                            ...
                            <button type="submit" class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
