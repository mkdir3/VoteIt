    ...
    <div class="idea__buttons__container">
                        ...
                        <div class="flex items-center space-x-2 mt-4 md:mt-0">
                            ...
                            <button @click="isOpen = !isOpen"
                                ...
                                <ul x-cloak x-show.transition.origin.top.left.duration.500ms="isOpen"
                                    ...
                                    class="absolute w-44 font-semibold text-xs text-left bg-white shadow-dialog rounded-xl z-10 py-3 ml-6 md:ml-6 top-8 md:top-6 right-0 md-left-0">
                                    <li><a href=""
        ...
        <div class="buttons-container flex items-center justify-between mt-6">
            <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
                    ...
                    <div x-cloak x-show.transition.origin.top.left.duration.500ms="isOpen" @click.away="isOpen= false"
                        ...
                        <form action="#" class="space-y-4 px-4 py-6">
                            ...
                            <div class="flex flex-col md:flex-row items-center md:space-x-3">
                                <button type="button"
                                    class="flex items-center justify-center h-11 w-full md:w-1/2 text-xs bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white">
                                    Envoyer
                                </button>
                                <button type="button"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-4 text-gray-600 transform -rotate-45" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div x-data="{ isOpen: false }" class="relative">
                    <button type="button" @click="isOpen = !isOpen"
                        class="flex items-center justify-center w-36 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3 mt-2 md:mt-0">
